      ...
      <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 sm:py-24 md:px-8">
        ...
        <div className="mb-12 sm:mb-16">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            {/* Support Indicator */}
            <div data-support className="shrink-0">
        ...
        <div className="space-y-1 mb-16 sm:mb-24">
          ...
          >
            <div className="flex items-center justify-between gap-3 sm:gap-4">
              ...
              <svg 
                className="w-4 h-4 sm:w-5 sm:h-5 shrink-0 text-black group-hover:text-gray-400 group-hover:translate-x-1 transition-all" 
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
                strokeWidth={2}
